...
-   **Corrección de Stats Dinámicos**: Integración de recálculo instantáneo de estadísticas (`calcStats`) cada vez que se inyecta un cambio en la forma, tipo o naturaleza mediante las herramientas Debug, evitando tener que meter/sacar al Pokémon del PC para aplicar los cambios.
